...
In contrast to that, \citeauthor{austin2009efficient} outline a fully dynamic encoding of information flow policies in \citetitle{austin2009efficient} \cite{austin2009efficient}. They achieve this by utilizing a dynamic type system, therefore giving up the advantages of static analysis in return for being able to encode dynamically changing policies on the language level.