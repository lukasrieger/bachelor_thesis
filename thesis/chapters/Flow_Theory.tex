...
Given these foundational definitions, \citeauthor{Goguen_Meseguer_82} proceed to define three kinds of non-interference: 
\begin{enumerate}
...
\textbf{TODO: Missing explanations for \(p_a \) etc!!! Also, what are abilities ?!}
...
The main challenge that one faces when trying to \emph{verify} whether Hagrid adheres to these policies, is that the set of theoretically visible identities is constantly changing and therefore dynamic.

In the following chapter we present a possible approach that allows us to verify these dynamic privacy and declassification policies.

\textbf{Todo: Is this enough? Should probably mention some of the new concepts introduced here in later chapters aswell...}
